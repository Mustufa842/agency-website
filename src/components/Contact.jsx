...
const FIELD_CLASS =
  'w-full input-premium bg-white/80 backdrop-blur-sm border border-ink/15 rounded-xl px-4 py-3.5 text-sm placeholder:text-ink/35 focus-ring focus:border-teal focus-visible:border-teal transition-all duration-300 hover:border-ink/30'
  ...
  return (
    <section id="contact" className="py-20 md:py-28 relative overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div className="absolute -top-24 -right-24 w-96 h-96 rounded-full bg-gradient-to-br from-teal/15 via-coral/10 to-transparent blur-3xl animate-float-slow" />
        <div className="absolute -bottom-24 -left-24 w-96 h-96 rounded-full bg-gradient-to-tr from-coral/15 via-amber/10 to-transparent blur-3xl animate-float-slow" style={{ animationDelay: '2s' }} />
      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        {status === 'sent' ? (
          ...
          >
            <div className="shadow-glow-teal w-16 h-16 rounded-full bg-teal/20 mx-auto mb-4 flex items-center justify-center">
          ...
          <div className="perspective-container">
            <motion.form 
              ...
              className="glass card-inner-light grid sm:grid-cols-2 gap-5 rounded-2xl p-8 border border-ink/10 shadow-xl shadow-ink/5 relative"
              initial={{ opacity: 0, y: 20 }}
              animate={inView ? { opacity: 1, y: 0 } : {}}
            ...
            >
              ...
              <div className="sm:col-span-2">
                <motion.button
                  ...
                  className="shimmer overflow-hidden relative inline-flex items-center gap-2 bg-gradient-to-r from-coral to-coral-dark text-white font-semibold px-8 py-4 rounded-full shadow-lg shadow-coral/30 hover:shadow-elevated transition-all duration-300 focus-ring disabled:opacity-60"
