...
const PROJECTS = [
  {
    ...
    tag: 'Live',
    desc:
      'Restaurant website concept with menu presentation, online ordering, reservations and mobile-friendly customer experience.',
    ready: true,
    link:
      'https://ember-and-bloom-cafe-4qdua24xa-mustufa842s-projects.vercel.app/',
  ...
  },
  {
    ...
    ready: true,
    desc:
      'Full-stack salon booking platform with ASP.NET Core, SQL Server, an admin dashboard, real-time booking and email confirmations.',
    link:
      'https://maison-elegance-frontend.mustufaaijaz1234.workers.dev/',
  ...
  },
  {
    ...
    ready: true,
    desc:
      'Modern dental clinic website with service information, online appointment booking and patient-focused navigation.',
    link:
      'https://aurelia-dental.mustufaaijaz1234.workers.dev/',
    screenshot: dentalPreview
  },
  {
    title: 'Gym Website',
    tag: 'Coming Soon',
    ...
    <div className="w-full h-full flex flex-col">
      ...
      <div className="relative flex-1 overflow-hidden bg-white">
        ...
        {!loaded &&
          ...
          screenshot && (
            <div
              className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-teal/[0.08] to-amber/[0.06] shimmer"
              aria-hidden="true"
            >
        ...
        {screenshot &&
          !errored && (
            <img
              src={screenshot}
              alt={`${title} website designed and developed by Tech Web Studio`}
              loading="lazy"
              decoding="async"
              width={
                title === 'Restaurant Website'
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <h2
              id="portfolio-title"
              className="font-display font-bold text-3xl md:text-4xl lg:text-5xl tracking-tight max-w-3xl leading-[1.1] mb-6"
            >
              Website projects for real business industries.
            </h2>

            <p className="text-ink/65 max-w-3xl text-lg leading-relaxed mb-14">
              Explore examples of restaurant, salon and dental website
              projects created by Tech Web Studio. Our portfolio focuses
              on responsive design, useful business functionality,
              clear navigation and customer-focused experiences.
            </p>
          </motion.div>
